...
{{--        <img class="object-cover h-full w-full bg-center bg-repeat" src="{{ asset('assets/img/background.png') }}" alt="background" style="filter: brightness(0.6) blur(0.8px);">--}}
{{--    </div>--}}
<div id="background" class="absolute left-0 top-0 h-full w-full">
...
<div id="nawigacja" class="flex items-center justify-between mx-5">
    <nav class="relative">
        <a
            href="{{ route('login') }}"
    ...
    <img class="relative w-28 h-28" src="{{ asset('assets/img/logo4.png') }}" alt="logo">
    @if (Route::has('login'))
        <nav class="relative">
            @auth
                <a
            ...
            @else
                ...
                @if (Route::has('register'))
                    <a
                        href="{{ route('register') }}"
{{--                        class="rounded-md px-3 py-2 hover:text-pink-300 transition-all duration-500"--}}
{{--                        class="rounded-md px-3 py-2 ring-1 ring-transparent hover:text-pink-300 focus:outline-none focus-visible:ring-[#FF2D20] transition-all duration-300"--}}
{{--                    >--}}
{{--                        Zarejestruj--}}
                    class="relative inline-block px-3 py-2 overflow-hidden group border-transparent transition-all duration-500">
